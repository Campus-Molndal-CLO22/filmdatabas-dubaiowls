...
Movie film = new() {Title = "Star Warrr", Year = 1980, Genre = "Sci-Fi", Actors = "Mark Hamill" , IMDB = "ABC" };
Actor actor = new() { Name = "Brad Pitss", Age = 58, BornYear = 1963, Movies = "Fight Club\nThe Big Short"};
